...
examples_map.update(examples_mmlu)
assert len(examples_map) == len(examples_gsm8k) + len(examples_math) + len(examples_lean4) + len(
    examples_mmlu_pro
) + len(examples_mmlu), "Duplicate keys in examples!"
