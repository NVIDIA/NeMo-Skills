...
class PPOVerlTask:
    ...
    def format_train_args(self):
        cmd = (
            ...
            "   data.train_files=/lustre/fsw/llmservice_nemo_reasoning/wedu/data/deepseek_r1/rl_data "
            "   data.val_files=/lustre/fsw/llmservice_nemo_reasoning/wedu/data/deepseek_r1/rl_data "
            "   data.train_batch_size=16 "
            "   data.max_prompt_length=512 "
            "   data.max_response_length=512 "
            "   actor_rollout_ref.model.path={self.model} "
            "   actor_rollout_ref.actor.optim.lr=1e-6 "
            ...
            "   trainer.project_name='verl-megatron' "
            "   trainer.experiment_name='14b-test' "
            f"   trainer.default_local_dir={self.output_dir}/checkpoints "
            f"   trainer.n_gpus_per_node={self.num_gpus} "
            f"   trainer.nnodes={self.num_nodes} "
            f"  +trainer.timeout={self.timeout} "
