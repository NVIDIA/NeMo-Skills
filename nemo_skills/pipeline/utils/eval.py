...
def prepare_eval_commands(
    ...
    for benchmark_or_group, rs_num in benchmarks_or_groups.items():
        ...
        for benchmark_args in cur_benchmarks:
            ...
            if benchmark_args.requires_sandbox and keep_mounts_for_sandbox:
                LOG.warning("Found benchmark (%s) which requires sandbox, keeping mounts for sandbox.", benchmark)
