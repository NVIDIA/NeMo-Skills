...
class AutoformalizationExecutionModel(BaseModel):
    def __init__(self, sandbox: Sandbox, model: str, **kwargs):
    ...
    def _build_request_body(
        self, top_k, min_p, repetition_penalty, extra_body: dict = None
    ):
        full_extra_body = {
            "min_p": min_p,
    ...
    def _build_completion_request_params(
        ...
        ), "reasoning_effort is not supported for text completion requests"
        ...
        return {
            ...
            "timeout": timeout,
            "extra_body": self._build_request_body(
                top_k, min_p, repetition_penalty, extra_body=extra_body
            ),
        }
