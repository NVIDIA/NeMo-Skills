...
In this tutorial, we will reproduce the evals for the [Llama-3.3-Nemotron-Super-49B-v1.5](nvidia/Llama-3_3-Nemotron-Super-49B-v1_5){target="_blank"} model using NeMo-Skills.
