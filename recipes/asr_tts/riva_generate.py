...
class RivaGenerationTask(GenerationTask):
    ...
    def wait_for_server(self):
            ...
            for endpoint in health_endpoints:
                try:
                    ...
                    response = requests.get(
                        f"http://{host}:{http_port}{endpoint}",
                        timeout=5
                    )
        ...
        raise ValueError(f"Server health check did not pass after {max_attempts*sleep_time} seconds. Check your server configuration.")    
