...
### NGC API Key
The `NGC_API_KEY` environment variable must be present in your cluster configuration to pull Riva NIM containers from NGC. Add it to your cluster config file (e.g., `cluster_configs/dfw.yaml`):
