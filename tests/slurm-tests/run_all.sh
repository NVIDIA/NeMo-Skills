...
sleep 10
python tests/slurm-tests/qwen3coder_swebench/run_test.py --cluster $CLUSTER --workspace /workspace/nemo-skills-slurm-ci/$CURRENT_DATE/qwen3coder_swebench --expname_prefix qwen3coder_swebench_$CURRENT_DATE --container_formatter /swe-bench-images/swebench_sweb.eval.x86_64.{instance_id}.sif &
wait
